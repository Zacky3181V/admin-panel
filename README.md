...
## Token for Store
If everything is fine project should launch with no errors. You will see clerk authentication window and after that you must create first store then you will be redirected to dashboard page. Please go to **Settings** tab and find the token you will need it when setting up the [Store](https://github.com/Zacky3181V/store) project
